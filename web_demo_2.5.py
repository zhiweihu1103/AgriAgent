...
# Load model
model_path = '/data/Users/hzw/reproduce_code/agriculture-vision/MiniCPM-V-main/finetune/output/output_minicpmv2_lora'
...
# launch
demo.launch(share=False, debug=True, show_api=False, server_name="")
